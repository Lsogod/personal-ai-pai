...
LONG_TERM_MEMORY_ENABLED=true
LONG_TERM_MEMORY_MIN_CONFIDENCE=0.75
LONG_TERM_MEMORY_TTL=180
LONG_TERM_MEMORY_RETRIEVE_LIMIT=6
LONG_TERM_MEMORY_CONTEXT=8000
LONG_TERM_MEMORY_DEBOUNCE=12
```
...
<CardGroup cols={2}>
  <Card title="架构概览" icon="sitemap" href="/architecture/single-agent">
    了解 PAI 的单 Agent + Harness 架构设计
  </Card>
